...
public class ExamComment {
    ...
    public ExamComment(Long id, Users userId, Exam exam, String comment, CommentsStatus status, String createdBy, LocalDateTime created, String modifiedBy, LocalDateTime modified) {
        this.id = id;
        this.userId = userId;
        this.exam = exam;
