...
import com.itgarden.website.exam.ripository.RateRepository;
...
public class CustomerRateController {
    ...
    public String index(Model model) {
        ...
        model.addAttribute("ratelist", rateRepository.findByUserId(users,page));
        return "student/rate/index";
    }
    ...
    public String save(Model model, @PathVariable Long examid, @Valid Rate rate, BindingResult bindingResult, RedirectAttributes redirectAttributes) {
        ...
        return "redirect:/customerrate/index";
    }
