...
@PreAuthorize("hasAuthority('student-question')")
...
//                stream.close();
                ...
                question.getExam();
                return "redirect:/exam/question-by-exam/{examid}";
    ...
    public String details(Model model, @PathVariable Long id, Question question) {
        ...
        return "catalog/question/question_details";
    }
    ...
    public String answer_by_question(Model model, @PathVariable Long qid, Question question) {
        ...
        return "catalog/question/answer-by-question";
    }
