...
public class BlogController {
    ...
    public String index(Model model) {
        model.addAttribute("bloglist", blogRepository.findAll(Sort.by(Sort.Direction.DESC, "id")));
...
//                stream.close();
            ...
            Blog blogs = blogRepository.getOne(blog.getId());
    ...
    public String details(Model model, @PathVariable Long id, Blog blog) {
        ...
        blogRepository.save(blog);
        return "blog/blog/blog_details";
    }

    @RequestMapping("/edit/{id}")
    public String edit(Model model, @PathVariable Long id, Blog blog) {
        model.addAttribute("blog", blogRepository.getOne(id));
